...
import { Shield, Clock, DollarSign, Calendar, CheckCircle2 } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 mb-6 text-lg">
                            Premium Moving Services sets ourselves apart with our dedication to ensuring quality service coupled with safety and efficiency at the fore-front. We offer flexibility for each project and can meet your needs whatever they may be.
                        </p>
                        <p className="text-gray-700 mb-6 text-lg">
                            We pride ourselves on efficiency, careful handling of your belongings, and transparent pricing with no
                            hidden fees. Whether you're moving a studio apartment or a family home, our team is trained to make your
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                            {featuresData.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 className="font-medium text-moving-navy">{feature.title}</h4>
