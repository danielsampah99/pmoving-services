...
const images = [
  {
    url: 'https://images.unsplash.com/photo-1694715669993-ea0022b470f7?w=1200&auto=format&fit=crop&q=80',
    alt: 'Professional movers loading a moving truck',
  },
  {
    url: 'https://images.unsplash.com/photo-1685119166946-d4050647b0e3?w=1200&auto=format&fit=crop&q=80',
    alt: 'Movers wrapping furniture with protective material',
  },
  {
    url: 'https://images.unsplash.com/photo-1590464228051-072b8316d24d?w=1200&auto=format&fit=crop&q=80',
    ...
    <div className="relative bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4 md:px-8">
        <div className="text-white max-w-2xl w-full">
          ...
          {/* Call-to-action */}
          {/* Uncomment to activate CTA */}
          {/* 
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <div className="bg-white text-moving-navy px-6 py-3 rounded-lg font-bold text-lg">
              Starting at <span className="text-moving-orange">$99/hr</span>
            </div>
            <a
              href="#quote-form"
              className="bg-moving-orange hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold text-lg transition-colors"
            >
              Get Free Quote
            </a>
          </div>
