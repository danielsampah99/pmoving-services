				...
				<div className="max-w-7xl mx-auto space-y-12">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="space-y-4">
							...
							<p className="text-gray-700">
								Our logistics services are designed to streamline your
								operations and improve efficiency. We combine industry expertise
								with cutting-edge technology to deliver optimal results.
							</p>
							<p className="text-gray-700">
