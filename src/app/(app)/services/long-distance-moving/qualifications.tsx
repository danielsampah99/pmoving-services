...
const serviceApproachData: RichData[] = [
	{
		...
		description:
			"Every item is inventoried, padded, and strategically loaded for cross-country stability.",
	},
	{
		id: 2,
		name: "Secure Transportation",
		description:
			"Air-ride trucks, trained drivers, and mapped routes ensure safe delivery.",
	},
	{
		id: 3,
		name: "Unloading, Placement & Reassembly",
		description:
			"We place furniture where it belongs and reassemble what we disassembled.",
	},
	{
		id: 4,
		...
		<div className="mx-auto flex flex-col gap-16 py-16 sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-5 xl:gap-x-20 xl:px-10">
			...
			<div className="w-full flex-auto">
				...
				<p className="mt-6 text-base text-pretty text-gray-500">
					A move is considered long distance when it crosses state lines or
					exceeds 400 miles compared to{" "}
					<Link href="/services/local-moving">local moves.</Link> These
					relocations require:
				</p>
				...
				<div className="mt-10 flex text-gray-700">
					This is where experience matters most, which our premium long distance
					movers have.
				</div>
			</div>
		</div>
			...
			<div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
				<div className="col-span-2">
					...
					<p className="mt-6 text-base/7 text-gray-600">
						We use industry-grade moving materials and proven methods to prevent
						shifting, pressure damage, and vibration wear during transit.
					</p>
				</div>
					...
					{serviceApproachData.map((sa) => (
						<div key={sa.id} className="relative pl-9">
							<dt className="font-semibold text-gray-900">
								<CheckIcon
									aria-hidden="true"
									className="absolute top-1 left-0 size-5 text-yellow-500"
								/>
								{sa.name}
							</dt>
	...
	<div className="mx-auto max-w-7xl">
		<div className="mx-auto flex lg:flex-row-reverse flex-col gap-16 py-16 sm:p-8 lg:mx-0 lg:max-w-none lg:items-center lg:py-5 xl:gap-x-20 xl:px-10">
			...
			<div className="w-full flex-auto">
				...
				<p className="mt-6 text-base text-pretty text-gray-500">
					Unlike national van lines that operate on volume, we operate on
					precision and communication. <br />
					What sets us apart:
				</p>
				<ul className="mt-6 grid grid-cols-1 gap-x-8 gap-y-3 text-base/7 text-gray-600 sm:grid-cols-2">
				...
				<div className="mt-10 flex text-gray-700">
					We don’t hand your move off to a third party. We execute it.{" "}
				</div>
			</div>
		</div>
	</div>
...
const pricingData = [
	{
		...
		description:
			"The total mileage between your pickup and delivery locations directly impacts fuel, labor, and time costs.",
		icon: GlobeAltIcon,
	},
	{
		name: "Weight and volume of items",
		description:
			"The total mass and space your belongings occupy determine the size of the truck and the crew needed.",
		icon: ArchiveBoxIcon,
	},
	{
		name: "Packing level requested",
		description:
			"Whether you opt for self-packing, partial, or full-service packing by our team influences labor and material costs.",
		icon: InboxStackIcon,
	},
	{
		name: "Access challenges",
		description:
			"Factors like multiple flights of stairs, long walks to the truck, or elevator availability at both locations can affect labor time.",
		icon: BuildingOfficeIcon,
	},
	{
		name: "Storage services",
		description:
			"Temporary or long-term storage solutions needed during your move will add to the overall cost.",
		icon: HomeModernIcon,
	},
	{
		name: "Timing and delivery window",
		description:
			"The flexibility of your moving dates and the desired timeframe for delivery can impact pricing, especially during peak seasons.",
				...
				{pricingData.map((pd) => (
					<div key={pd.name} className="relative pl-9">
						<dt className="inline font-semibold text-gray-900">
							<pd.icon
								aria-hidden="true"
								className="absolute top-1 left-1 size-5 text-moving-yellow"
							/>
							{pd.name}
						</dt>{" "}
