					...
					<div className="max-w-7xl mx-auto space-y-12">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
							<div className="space-y-4">
								...
								<p className="text-gray-700">
									If you are planning a warehouse move, you will know that there
									is a great deal of planning involved to make sure that
									everything runs smoothly. With the help of our Premium movers,
									you can be rest assured that most of the hard work is done for
									you.
								</p>
								<p className="text-gray-700">
									Our expert warehouse relocation team will help to plan every
									detail of your business move. If you are interested to see how
									we can help to make sure your move goes as smooth as possible,
									get in touch with us today for a quote on your removal.
								</p>
							</div>
							<img
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
							<div className="space-y-4">
								...
								<p className="text-gray-700">
									Our Premium movers are trained and certified in light
									industrial relocation and we are able to complete even complex
									tasks. With over a decade of quality and value driven
									industrial moving experience, we can fit your timeline and
									your budget.
								</p>
							...
							<div className="bg-gray-100 p-6 rounded-lg">
								<p className="text-gray-700">
									We can provide all the labor required to complete your
									warehouse relocation. We are licensed, bonded, and insured.
								</p>
