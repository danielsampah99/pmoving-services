		...
		>
			<div className="max-w-7xl mx-auto px-4 py-12">
				<div className="space-y-8">
					...
					<section className="grid md:grid-cols-2 gap-8 items-center bg-white rounded-lg shadow-md p-6">
						<div className="space-y-4">
							...
							<p className="text-gray-600 text-lg">
								Moving a piano requires specialized knowledge, equipment, and
								expertise. Our professional piano movers provide:
							</p>
							...
							<p className="text-gray-600 mt-4">
								Trust our experienced team to move your valuable instrument with
						...
						<div className="grid md:grid-cols-3 gap-6">
							<div className="p-4 bg-gray-50 rounded-lg">
								...
								<p className="text-gray-600">
									We evaluate your piano's size, type, and moving path to create
							...
							<div className="p-4 bg-gray-50 rounded-lg">
								...
								<p className="text-gray-600">
									We secure your piano using specialized equipment and protect
									surrounding areas.
								</p>
							</div>
							<div className="p-4 bg-gray-50 rounded-lg">
								...
								<p className="text-gray-600">
									Your piano is carefully moved using proper techniques and
									transported in our specialized vehicles.
								</p>
							</div>
						</div>
					</section>
					...
					<section className="bg-white rounded-lg shadow-md p-6">
						<h2 className="text-3xl font-bold mb-4">
							Why Choose Our Piano Moving Service
						</h2>
						<div className="grid md:grid-cols-2 gap-6">
							<div>
								...
								<p className="text-gray-600">
									Our team is specifically trained in piano moving techniques
									and uses professional-grade equipment designed for safe piano
									transportation.
								</p>
							</div>
							<div>
								...
								<p className="text-gray-600">
									We provide full insurance coverage and take extra precautions
									to protect both your piano and your property during the move.
								</p>
							</div>
						</div>
					</section>
