    ...
    <div className="blog-card group h-full flex flex-col animate-fade-in">
      ...
      <div className="flex-1 p-5 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
          ...
          <a href={`/post/${post.id}`} className="inline-flex items-center text-blog-accent font-medium  hover:text-blog-accent/80 group-hover:translate-x-1 transition-transform duration-300">
