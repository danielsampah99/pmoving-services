  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        <h3 className="text-lg font-medium text-blog-primary mb-2">Subscribe to our newsletter</h3>
      ...
      {/* Recent posts */}
      <div>
        <h3 className="text-lg font-medium text-blog-primary mb-4">Recent Posts</h3>
        ...
        <a href="/" className=" text-blog-accent font-medium transition-colors hover:text-blog-accent/80 mt-4 inline-flex items-center text-sm">
      ...
      {/* Categories */}
      <div>
        <h3 className="text-lg font-medium text-blog-primary mb-4">Categories</h3>
        <ul className="space-y-2">
          <li>
            <a href="/" className="text-blog-secondary hover:text-blog-accent transition-colors text-sm">
              Packing Tips
            </a>
          </li>
          <li>
