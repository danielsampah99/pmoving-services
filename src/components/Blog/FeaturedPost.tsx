		...
		<div className="group relative h-[600px] rounded-xl overflow-hidden animate-scale-in">
			...
			<div className="absolute bottom-0 left-0 p-6 sm:p-8 w-full z-20">
				...
				<div className="flex items-center justify-between">
					...
					<a
						href={`/post/${post.id}`}
						className=" text-blog-accent font-medium  hover:text-blog-accent/80 text-white group-hover:translate-x-1 transition-transform duration-300 flex items-center"
					>
