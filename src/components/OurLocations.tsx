			...
			<div className="mx-auto max-w-5xl px-6">
				<div className="mx-auto grid gap-2 sm:grid-cols-5">
					<Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
						<CardHeader>
							<div className="md:p-6">
								...
								<p className="text-muted-foreground mt-3 max-w-sm text-sm">949 Schaller Dr S Maplewood, MN 55119</p>
							</div>
						</CardHeader>
					...
					<Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
						<h2 className="mx-auto my-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:p-6">Minneapolis Moving Company</h2>
						<p className="text-muted-foreground mt-3 max-w-sm text-sm">2514 Plymouth Ave N, Minneapolis, MN 55411</p>
					...
					<Card className="group p-6 shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
						<p className="mx-auto mb-12 max-w-md text-balance text-center text-lg font-semibold sm:text-2xl">Lakeville Moving Company</p>
						<p className="text-muted-foreground mt-3 max-w-sm text-sm">829 3rd Ave SE #285 Rochester, MN 55904</p>
