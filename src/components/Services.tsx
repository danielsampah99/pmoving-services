...
export const Services: FC = () => {
	return (
		<div className="relative">
			<DropdownMenu>
				<DropdownMenuTrigger className="flex items-center gap-x-1 text-sm/6 font-semibold text-white hover:bg-moving-gray/10 focus-visible:bg-moving-gray/10">
					Moving Services
					<ChevronDownIcon
						aria-hidden="true"
...
const ServiceWithSubMenu: FC<{ service: Service }> = ({ service }) => {
	return (
		<DropdownMenuSub>
			<DropdownMenuSubTrigger className="group w-full text-left relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 data-hover:bg-gray-100 data-active:bg-gray-100">
				<a className="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
					<service.icon
						aria-hidden="true"
