				...
				<div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
					<div className="-mt-8 w-full max-w-2xl sm:max-w-lg sm:-mt-16 md:-mt-8 xl:-mb-8 xl:w-96 xl:flex-none">
						<div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
							<div className="absolute inset-0 h-3/4 w-2/3 rounded-2xl p-3 bg-moving-yellow object-cover shadow-2xl">
								<img
									src="/bbb-logo.png"
					...
					<div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-8 xl:py-3">
						<figure className="relative isolate pt-6 sm:pt-3 xl:pt-4">
