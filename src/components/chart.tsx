...
function ChartTooltipContent({
    ...
    labelKey?: string
    label: string | number
    payload: CustomChartProps['payload']
}) {
	    ...
	    if (labelFormatter) {
		    return (
		        <div className={cn("font-medium", labelClassName)}>
		          {labelFormatter(value, payload as Payload<ValueType, NameType>[])}
		        </div>
	    	)
	    }
					...
					<div
              		...
              		>
                		{formatter && item?.value !== undefined && item.name ? (
                  			formatter(item.value, item.name, item as Payload<ValueType, NameType>, index, item.payload as Payload<ValueType, NameType>[])
                  		) : (
                    		<>
                      			{itemConfig?.icon ? (
                         			<itemConfig.icon />
...
function ChartLegendContent({
	...
	nameKey,
}: React.ComponentProps<"div"> & CustomChartProps) {
