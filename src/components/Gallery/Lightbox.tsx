...
import { X, ChevronLeft, ChevronRight, Maximize, Minimize, Info, } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            `}
                ...
                {/* Navigation controls */}
                <div className="absolute top-1/2 w-full flex justify-between items-center px-4 transform -translate-y-1/2" onClick={handleControlClick}>
                    {hasPrev && (
                        <button
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                        {currentImage.category.map((cat) => (
                            <span key={cat} className="text-xs px-2 py-1 bg-white/20 rounded-full">
                                {cat}
                            </span>
                        ))}
                    </div>
